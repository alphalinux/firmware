...
******************************************************************************/
#define FLASH_H_RCSID "$Id: flash.h,v 1.1.1.1 1998/12/29 21:36:06 paradis Exp $"
 ...
 * Initial CVS checkin
 *
 * Revision 1.3  1997/05/01  19:51:20  pbell
 * Updated for SX support.
 *
...
VOID pWriteFlashByte( IN ULONG FlashOffset, IN UCHAR Data );
UCHAR pReadFlashByte( IN ULONG FlashOffset );
