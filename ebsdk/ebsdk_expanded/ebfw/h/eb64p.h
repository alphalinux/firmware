...
/*
 *  $Id: eb64p.h,v 1.1.1.1 1998/12/29 21:36:06 paradis Exp $;
 */
 ...
 * Initial CVS checkin
 *
 * Revision 1.34  1996/08/19  04:08:53  fdh
 * Removed an obsoleted definition.
 *
 * Revision 1.33  1996/08/13  19:48:53  fdh
 * Added Epic CSR mask definition for Target Aborts.
 *
 * Revision 1.32  1996/05/25  10:52:26  fdh
 * Disabled am79c960 driver again after it was enabled
 * for testing.
 *
 * Revision 1.31  1995/12/17  22:48:00  fdh
 * Added TARGET_NAME definition.
 *
 * Revision 1.30  1995/12/15  19:29:16  cruz
 * Updated banner to reflect the name change from DECChip to Alpha.
 *
 * Revision 1.29  1995/12/15  16:41:09  cruz
 *  Defined FWUPDATE_FILE_ALT.
 *
 * Revision 1.28  1995/11/09  21:26:09  fdh
 * Disabled the am79c960 ethernet driver
 * to create a smaller ROM image.
 *
 * Revision 1.27  1995/11/01  16:22:16  cruz
 * Replaced ALLIED_TELESIS_AT_1500T by NEEDAM79C960_OPTIONAL.
 *
 * Revision 1.26  1995/10/19  20:11:22  cruz
 * Defined a new compiled switch called NEED_ETHERNET_ADDRESS which
 * enables certain portions of the network code if APECS_PASS1 is
 * defined.
 *
 * Revision 1.25  1995/10/03  20:13:39  fdh
...
#define TARGET_NAME "EB64P"
#define BANNER "Alpha 21064 and 21064A PCI Evaluation Board (EB64+) Debug Monitor"
#define PROMPT "EB64+ "
