...
PrintVersionID:				
	...
	lda $17, ( 0x00000901&0xffff)( $31)		;  ldah $17, (( 0x00000901+0x8000)>>16)($17)	; 
	bis	$31, $31, $16
...
srom_rdtest:
	...
	xor	$18, $17, $19		
		...
		lda	$29, 1($31);		lda $28, ( (	( (0x3a << 24) | (0x41 << 16) | (0x0a << 8) | (0x0d << 0) ))&0xffff)( $31)		;  ldah $28, (( (	( (0x3a << 24) | (0x41 << 16) | (0x0a << 8) | (0x0d << 0) ))+0x8000)>>16)($28)	; ;			bsr	$0, minidebugger ;
	srl	$16, 32, $0
		lda	$29, 2($31);		bis	$31, $0, $28;				bsr	$0, minidebugger ;			
		lda	$29, 2($31);		bis	$31, $16, $28;				bsr	$0, minidebugger ;			
		lda	$29, 1($31);		lda $28, ( (	( (0x00 << 24) | (0x3a << 16) | (0x57 << 8) | (0x20 << 0) ))&0xffff)( $31)		;  ldah $28, (( (	( (0x00 << 24) | (0x3a << 16) | (0x57 << 8) | (0x20 << 0) ))+0x8000)>>16)($28)	; ;			bsr	$0, minidebugger ;
	srl	$17, 32, $0
		lda	$29, 2($31);		bis	$31, $0, $28;				bsr	$0, minidebugger ;			
		lda	$29, 2($31);		bis	$31, $17, $28;				bsr	$0, minidebugger ;			
		lda	$29, 1($31);		lda $28, ( (	( (0x00 << 24) | (0x3a << 16) | (0x52 << 8) | (0x20 << 0) ))&0xffff)( $31)		;  ldah $28, (( (	( (0x00 << 24) | (0x3a << 16) | (0x52 << 8) | (0x20 << 0) ))+0x8000)>>16)($28)	; ;			bsr	$0, minidebugger ;
	srl	$18, 32, $0
		lda	$29, 2($31);		bis	$31, $0, $28;				bsr	$0, minidebugger ;			
		lda	$29, 2($31);		bis	$31, $18, $28;				bsr	$0, minidebugger ;			
	...
	beq	$19, equal		
not_equal:
		lda	$29, 1($31);		lda $28, ((0x20 << 0) | (0x58 << 8))($31);		bsr	$0, minidebugger ;
