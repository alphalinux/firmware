...
Sys_Reset:
	...
	hw_mtpr	$1	, 0x148			 
		...
		ldah	$12	, (( ((1<<23) | (1<<24))+0x8000) >> 16)($31	); 	lda	$12	, ( ((1<<23) | (1<<24))&0xffff)($12	)		 
	bic	$1	, $12	, $16					 
	  	hw_stq/p	$16	, ((0x518-0x418	)&0x3FF)($13	)	 
...
Sys_Cserve:
	...
	cmpeq	$18, 0x21, $0	
	bne	$0	, Sys_Cserve_Rd_MafMode

	cmpeq	$18, 0x22, $0	
	bne	$0	, Sys_Cserve_Wr_MafMode
	hw_rei                           

...
Sys_Cserve_Jtopal:
	...
	zap	$1	, 0xFC, $1			 
		...
		hw_ldq/p	$1	, ((0x518-0x418	)&0x3FF)($23)	 
		hw_ldq/p	$2, ((0x510-0x418	)&0x3FF)($23)	 
...
pvc$osf80$5080:
	...
	lda	$8	, 0x418	($8	)	 
	  	...
	  	hw_stq/p	$16	, ((0x518-0x418	)&0x3FF)($8	)	 
	  	hw_stq/p	$17, ((0x510-0x418	)&0x3FF)($8	)	 
