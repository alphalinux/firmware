...
link.exe /NOLOGO /SUBSYSTEM:console /INCREMENTAL:yes /PDB:.\WinDebug/%make%.pdb /DEBUG /MACHINE:ALPHA /OUT:.\WinDebug/%make%.exe @link.dbg
...
link.exe /NOLOGO /SUBSYSTEM:console /INCREMENTAL:no /PDB:.\WinRel/%make%.pdb /MACHINE:ALPHA /OUT:.\WinRel/%make%.exe @link.rel
