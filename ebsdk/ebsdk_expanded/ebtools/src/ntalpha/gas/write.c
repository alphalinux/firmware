 ...
 * Initial CVS checkin
 *
 * Revision 1.1  1995/05/04  20:50:11  fdh
 * Initial revision
 *
...
#ifdef alpha
  /* See note in a_out.h on use of relocation_info structure for alpha */
  tr_siz = RELOCATION_INFO_SIZE * fixup_segment (text_fix_root, N_TEXT);
#else
...
#ifdef alpha
  dr_siz=RELOCATION_INFO_SIZE * fixup_segment (data_fix_root, N_DATA);
#else
